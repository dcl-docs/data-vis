...
In this situation and others, you'll want to override the default. With `coord_fixed()`, you can use the `ratio` argument to specify the aspect ratio of your plot, with a default of 1.
