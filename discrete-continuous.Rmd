...
In this section, we'll use data collected by the [American Community Survey (ACS)](https://www.census.gov/programs-surveys/acs/) on languages spoken at home across the US. `dcldata::languages_states` contains data from the 2013 ACS on the number of at-home speakers of non-English speakers by state. 
